...
class _WordListScreenState extends State<WordListScreen> {
  ...
  int _flashcardViewCount = 0; // ?åÎûò?úÏπ¥???ÑÎ©¥ Í¥ëÍ≥†??Ïπ¥Ïö¥??

  // Î¶¨Ïä§??Î™®Îìú???§ÌÅ¨Î°?Ïª®Ìä∏Î°§Îü¨
  ...
  String _getAlphabeticalText() {
    // Í∞ÑÎã®???∏Ïñ¥Î≥??çÏä§??Î∞òÌôò
    final locale = Localizations.localeOf(context).languageCode;
    switch (locale) {
      case 'ko':
        return '?åÌååÎ≤≥Ïàú';
      case 'ja':
        return '?¢„É´?ï„Ç°?ô„ÉÉ?àÈ†Ü';
      case 'zh':
        return 'Â≠óÊØçÈ°∫Â∫è';
      default:
        return 'Alphabetical';
